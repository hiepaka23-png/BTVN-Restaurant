...
// cổng 4200 — để mở app từ điện thoại/máy khác trong cùng mạng qua IP của máy chạy server (vd:
// http://192.168.1.10:4200) không bị chặn CORS. Không hardcode 1 IP cụ thể vì IP LAN có thể đổi
// (DHCP) mỗi lần khởi động lại router/máy.
const LAN_ORIGIN_PATTERN =
  /^http:\/\/((localhost)|(127\.0\.0\.1)|(192\.168\.\d{1,3}\.\d{1,3})|(10\.\d{1,3}\.\d{1,3}\.\d{1,3})|(172\.(1[6-9]|2\d|3[01])\.\d{1,3}\.\d{1,3})):4200$/;
